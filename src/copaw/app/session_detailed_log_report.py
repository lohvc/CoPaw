...
def build_log_payload(
    *,
    ...
    info["record_type"] = "dialog_full_trace"
    info["report_schema"] = "copaw_session_full_trace_v1"
    info["event_stream"] = []
    info["completion"] = dialog.completion
    return {
...
def build_heartbeat_payload(
    *,
    ...
    info = {
        ...
        "report_schema": "copaw_session_full_trace_v1",
...
def post_dialog(
    *,
    ...
    try:
        ...
        raise RuntimeError(f"HTTP {exc.code} 调用日志接口失败: {detail}") from exc
